...
## Project Structure
    ...
    ├── spring_sun_dev_94610  # Django project configurations
...
1. Clone this repo and `cd spring_sun_dev_94610`
...
2. Clone this repo and `cd spring_sun_dev_94610`
