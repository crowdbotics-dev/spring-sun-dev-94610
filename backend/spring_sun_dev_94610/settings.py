"""
Django settings for spring_sun_dev_94610 project.
...
ROOT_URLCONF = 'spring_sun_dev_94610.urls'
...
WSGI_APPLICATION = 'spring_sun_dev_94610.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_sun_dev_94610 API",
    "DESCRIPTION": "API documentation for spring_sun_dev_94610 App",
    "VERSION": "v1",
}
